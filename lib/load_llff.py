...
def spherify_poses(poses, bds, depths):
    ...
    zh = centroid[2]
    radcircle = np.sqrt(rad**2-zh**2)*0.2
    new_poses = []
...
class LLFF_Dataset(torch.utils.data.Dataset):
    def __init__(self, basedir, width = None, height=None, factor = None, spherify = False, frameids=[], test_views = []):
    ...
    def __getitem__(self, idx):
        ...
        images, depths, poses, bds, render_poses, i_test = load_llff_data(self.basedir, factor = self.factor,
